#!/bin/bash
# Test runner for 2-shard 1-replica configuration only
...
echo "=== Mako TPC-C: 2-Shard 1-Replica Test Suite ==="
...
run_test() {
  ...
  # Wait for benchmark duration + 40 second buffer for 2-shard startup/shutdown
  # Using 40s buffer as 2-shard setup takes longer to load data
  sleep $((DURATION + 40))
