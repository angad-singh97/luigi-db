...
/**
 * LuigiServer: Standalone server for Luigi timestamp-ordered execution protocol.
 * 
 ...
 */
class LuigiReceiver : public mako::TransportReceiver {
 public:
...
class LuigiServer {
 public:
    LuigiServer(const std::string& config_file, 
