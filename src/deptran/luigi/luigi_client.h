...
/**
 * LuigiClient: Standalone client for Luigi timestamp-ordered execution protocol.
 * 
...
class LuigiDispatchBuilder {
 public:
     ...
     */
    LuigiDispatchBuilder& AddWrite(uint16_t table_id, 
...
class LuigiClient {
 public:
    LuigiClient(const std::string& config_file,
