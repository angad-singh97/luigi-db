...
const uint64_t takeover_timeout_us = 15000;  // TODO: what to set here?
const uint64_t finalize_timeout_us = 200000;

class CopilotPlusCommo;
...
class CopilotPlusCoordinator : public Coordinator {
 ...
 private:
  ...
  void initFastTakeover(shared_ptr<CopilotPlusData>& ins);
  void clearStatus();
 ...
 public:
  CopilotPlusServer* sch_ = nullptr;
