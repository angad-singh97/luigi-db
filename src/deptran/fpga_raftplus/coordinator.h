...
class FpgaRaftPlusCommo;
class FpgaRaftPlusServer;
class CoordinatorFpgaRaftPlus : public Coordinator {
 public:
//  static ballot_t next_slot_s;
  FpgaRaftPlusServer* sch_ = nullptr;
 private:
  ...
  FpgaRaftPlusCommo *commo() {
    ...
    return (FpgaRaftPlusCommo *) commo_;
  }
 ...
 public:
  ...
  CoordinatorFpgaRaftPlus(uint32_t coo_id,
                        int32_t benchmark,
